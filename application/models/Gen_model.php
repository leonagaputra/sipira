...
class Gen_model extends CI_Model{
    ...
    public function get($table = NULL, $data = NULL, $single = FALSE, $count = FALSE, $limit = NULL, $start = NULL, $order = NULL, $desc = FALSE, $like = NULL, $where_in = NULL, $wherein_val = NULL)
    {
        $ttable = $this->table;
        if($table != NULL){
            $ttable = $table;
    ...
    function update_data($table, $data, $id = NULL, $where = NULL){
        if($where){
            $this->db->where($where);
        }
        else {
