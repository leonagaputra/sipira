        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-shrink">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="#page-top">Bagaimana tanggapan Anda terhadap pelayanan kami?</a>
                </div>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="col-lg-2 col-xs-2">
                        <!--<button>-->
                        <a href="javascript:survey(1);" class="btn btn-warning">                           
                            <img class="img-responsive" width="120px" height="120px" src="<?php echo $base_url ?>img/smiley/0.png" alt="">Keren&nbsp;
                        </a>
                        <!--</button>-->
                    </div>
                    <div class="col-lg-2 col-xs-2">
                        <!--<button>-->
                        <a href="javascript:survey(2);" class="btn btn-warning">
                            <img class="img-responsive" width="120px" height="120px" src="<?php echo $base_url ?>img/smiley/1.png" alt="">Puas
                        </a>
                        <!--</button>-->
                    </div>
                    <div class="col-lg-2 col-xs-2">
                        <!--<button>-->
                        <a href="javascript:survey(3);" class="btn btn-warning">
                            <img class="img-responsive" width="120px" height="120px" src="<?php echo $base_url ?>img/smiley/3.png" alt="">Biasa
                        </a>
                        <!--</button>-->
                    </div>
                    <div class="col-lg-2 col-xs-2">
                        <!--<button>-->
                        <a href="javascript:survey(4);" class="btn btn-warning">
                            <img class="img-responsive" width="120px" height="120px" src="<?php echo $base_url ?>img/smiley/4.png" alt="">Kurang 
                        </a>
                        <!--</button>-->
                    </div>
                    <div class="col-lg-2 col-xs-2">
                        <!--<button>-->
                        <a href="javascript:survey(5);" class="btn btn-warning">
                            <img class="img-responsive" width="120px" height="120px" src="<?php echo $base_url ?>img/smiley/6.png" alt="">Buruk
                        </a>
                        <!--</button>-->
                    </div>
                </div>
