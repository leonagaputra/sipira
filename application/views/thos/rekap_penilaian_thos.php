<section class="content-header">
    <h1>
        Rekap Penilaian Thos
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Rekap Penilaian THOS</a></li>
...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form id="search_form" role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/rekap_penilaian_thos" enctype="multipart/form-data">
                            ...
                            <tbody>
                                ...
                                if (!empty($datas)) {
                                    ...
                                    foreach ($datas as $data) { 
                                        //print_r($data);exit;
                                    echo "<tr id='row_' style='cursor:pointer;' onclick='show_rekap_penilaian_thos(". $data->ID .", ".$data->IYEAR.",  ".$data->ISEMESTER.")' >";                                                                                           
                                            echo "<td>".$i."</td>";
                                            echo "<td>" . $data->VNAMA . "</td>";
                                            echo "<td style='text-align:right'>" . $data->DNILAI . "</td>";                            
                                            echo "<td style='text-align:right'>" . $data->JML_PENILAI . "</td>";                                            
                                        echo "</tr>";
                                        $i++;
                                    }
                                }
