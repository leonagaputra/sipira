<section class="content-header">
    <h1>
        Input Penilaian Thos
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Input Penilaian Thos</a></li>
...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form id="search_form" role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/input_penilaian_thos/<?php echo $IYEAR; ?>/<?php echo $ISEMESTER; ?>" enctype="multipart/form-data">
                <?php
                    ...
                    <select id="ID_MSTTHOS" class="form-control" name="ID_MSTTHOS" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?>>
                      <?php
                        foreach ($list_thos as $obj){
                            echo "<option value='".$obj->ID."' ".((isset($submitted) && $submitted == 1)&&($values['ID_MSTTHOS']==$obj->ID) ? "selected" : "").">".$obj->VNAMA."</option>";
                        }                                         
                      ?>
                    </select>                   
                </div>
                <?php
                    ...
                    foreach($dtlnilaithos as $obj){
                        ...
                        echo "<div class='form-group'>";
                            ...
                            echo "<select class='form-control' name='DTL_NILAI[]' " . ((isset($submitted) && $submitted == 1) ? "disabled" : "") . " >";
                                for($j = 1; $j <= 10; $j++){
                                    echo "<option value='".($j*10)."'>".($j*10)."</option>";
                                }
                            echo "</select>";
                        echo "</div>";
                        $i++;
                ...
                <div class="box-footer">                    
                    ...
                    <a type="button" href="<?php echo $base_url; ?>index.php/backend/penilaian_thos/" class="btn btn-primary" >Back</a>
                </div>
            </form>
        </div>
        <!-- /.box-body -->
