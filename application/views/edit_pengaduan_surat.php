<section class="content-header">
    <h1>
        Edit Pengaduan Tertulis
        <small>Pengaduan Tertulis Nasabah/Konsumen Industri Jasa Keuangan</small>
    </h1>
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i>Edit Pengaduan Tertulis</a></li>
...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/edit_pengaduan_surat/<?php echo $ID;?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        //exit;
                        ?>
                        <input type="text" value="<?php echo $values['DTGLSRT']; ?>" name="DTGLSRT" class="form-control pull-right tanggal" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?> >
                    </div>
                </div>
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        //exit;
                        ?>
                        <input type="text" value="<?php echo $values['DTGLRCV'] ; ?>" name="DTGLRCV" class="form-control pull-right tanggal" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?> >
                    </div>
                </div>
                <div class="form-group">
                    <label>PIC OJK</label>                          
                ...
                <div class="form-group" id="ijk">
                    ...
                    <select id="VSTATSRT" class="form-control" name="VSTATSRT" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?>>                     
                        ...
                        foreach($list_stat as $obj){
                            echo "<option value='".$obj->ID."' ".((($values['VSTATSRT']==$obj->ID)) ? "selected" : "")." >".$obj->VNAMA."</option>";
                        }
                      ?>                        
                    </select>                        
                </div> 
                <div class="form-group" id="ijk">
                    ...
                    <select id="VSTATPRS" class="form-control" name="VSTATPRS" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?>>                     
                        ...
                        foreach($list_proses as $obj){
                            echo "<option value='".$obj->ID."' ".((($values['VSTATPRS']==$obj->ID)) ? "selected" : "")." >".$obj->VNAMA."</option>";
                        }
                      ?>                        
                    </select>                        
                </div>            
                <div class="box-footer">                   
                    ...
                    <a type="button" href="<?php echo $base_url; ?>index.php/backend/monitoring_pengaduan_surat" class="btn btn-primary" >Back</a>
                </div>
            </form>
        </div>
        <!-- /.box-body -->
