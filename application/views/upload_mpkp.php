...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/upload_mpkp" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    <label>Excel MPKP</label>
                    <input name="dokumen_mpkp" type="file" class="rancanganInputFile" >
                </div> 
                <div class="form-group">
                ...
                <div class="box-footer">
                    ...
                    <a type="button" href="<?php echo $base_url; ?>template/template.xls" class="btn btn-primary" >Download Template Dokumen</a>
                </div>
            </form>
        </div>
        <!-- /.box-body -->
