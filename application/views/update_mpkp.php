...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/update_mpkp/<?php echo $ID; ?>" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="VNOTADINAS" value="<?php echo $VNOTADINAS; ?>" class="form-control" placeholder="Enter Nomor Nota Dinas"  <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?>>                    
                </div>
                <div class="form-group">
                    <label>Kasus Posisi</label>
                    <textarea  name="VKASPOS" rows="10" cols="80"><?php echo $VKASPOS; ?></textarea>
                </div>
                <div class="form-group">
                    <label>Ketentuan Yang Dilanggar</label>
                    <textarea  name="VLANGGAR" rows="10" cols="80"><?php echo $VLANGGAR; ?></textarea>
                </div> 
                <div class="form-group">
                    <label>Keterangan</label>
                    <textarea  name="VKET" rows="10" cols="80"><?php echo $VKET; ?></textarea>
                </div> 
                <div class="form-group">
                ...
                <div class="box-footer">
                    <!--<a type="button" href="<?php echo $base_url; ?>index.php/backend/input_mpkp/<?php echo $ID; ?>" class="btn btn-primary" <?php echo (isset($submitted) && $submitted == 1) ? "" : "disabled"; ?>>Add New</a>-->
