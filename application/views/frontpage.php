        ...
        <nav class="navbar navbar-default navbar-fixed-top navbar-shrink">
            <div class="container">
                ...
                <div class="navbar-header page-scroll">
                    ...
                    <a class="navbar-brand" href="#page-top">SIPIRA</a>
                </div>
                ...
                <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li>
                            <!--<a href="<?php echo $base_url; ?>index.php/main/survey">Survey</a>-->
                            <!--<a href="https://docs.google.com/forms/d/e/1FAIpQLSe895baXthconAXxT1jUyg-JsCIkb7xNkxoGMudqidE_Vs_Lg/viewform?c=0&w=1&usp=mail_form_link">Survey</a>-->
                            <a href="<?php echo $base_url; ?>index.php/main/surveys">Survey</a>
                        </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        ...
                        <div class="intro-text">
                            <span class="name">SIPIRA</span>
                            <hr class="star-light">
                            <span class="skills">Sistem Informasi Pendukung Internal OJK Sulawesi Utara</span>
                        </div>
                    </div>
                </div>
            </div>
