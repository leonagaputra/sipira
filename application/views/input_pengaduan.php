<section class="content-header">
    ...
    <ol class="breadcrumb">
        <li><a href="#"><i class="fa fa-home"></i> Input Pengaduan</a></li>
...
<section class="content">
    <div class="box box-warning">       
        <!-- /.box-header -->
        <div class="box-body">
            <form role="form" method="post" action="<?php echo $base_url; ?>index.php/backend/input_pengaduan" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group date">
                        ...
                        //exit;
                        ?>
                        <input type="text" value="<?php echo (isset($submitted) && $submitted == 1) ? $values['DTGLPENG'] : $today; ?>" name="DTGLPENG" class="form-control pull-right" <?php echo (isset($submitted) && $submitted == 1) ? "disabled" : ""; ?> id="datepicker">
                    </div>
                </div>
                <div class="form-group">
                    <label>PIC OJK</label>                          
